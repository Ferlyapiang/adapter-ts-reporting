...
import { HistoryApplyCCModel, CountHistoryApplyCCModel } from "../model/HistoryApplyCCModel";
...
export class HistoryApplyCCMapper {
    ...
    public static toCount(applyCCModel: CountHistoryApplyCCModel): CountHistoryApplyCC {
        const countHistoryApplyCC: CountHistoryApplyCC = {
            total: applyCCModel.total
        }

        return countHistoryApplyCC
    }
